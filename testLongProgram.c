...
void main()
{
    ...
    PRINTS("Dear \0");
    PRINTS(name);
    PRINTS(", \r\n I would like to inform you that you do not need to grade \r\n Nicole, Elena, and Tim's Project. I have already determined that this \0");
    PRINTS(adj1);
    ...
    PRINTS(", which you can put down in the gradebook as \0");
    PRINTN(b);
    PRINTS(" out of \0");
    PRINTN(a);

    PRINTS(". \r\n Nicole, Elena, and Tim are my very favorite students because \r\n they are so \0");
    PRINTS(adj2);
